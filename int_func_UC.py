# -*- coding: utf-8 -*-
"""
Created on Thu Feb 17 11:52:18 2022
...
def int_dispatch_function_UC(indata):
    T = indata.T
    #DATA
    time = indata.time 
    gen= indata.gen
    ...
    integ.u_DA=pe.Var(integ.I, integ.T, domain=pe.Binary)
   ...
   # print(profit)
    ...
    plt.savefig('Heat_int_UC.pdf', dpi=100, bbox_inches='tight')
    plt.show    
   ...
   #             mode="expand", borderaxespad=0, ncol=3)
    ...
    plt.savefig('Power_int_UC.pdf', dpi=100, bbox_inches='tight')
    plt.show    
    #Dispatch and price
# =============================================================================
...
# =============================================================================
    ...
    ax7.set_ylim(-10, 300)
    plt.savefig('CHP_dispatch_int_big_UC.pdf', dpi=100, bbox_inches='tight')
    plt.show
    # =============================================================================
    # y_w={}    
    # for w in range(0,S):
