# -*- coding: utf-8 -*-
"""
Created on Thu Feb 17 13:12:22 2022
...
def SS_dispatch_func_UC(indata, L_DA_E_F, scen, u_DA):   
    np.random.seed(886)
    ...
    SS_NLP.u_DA=pe.Param(SS_NLP.I, SS_NLP.T, initialize=u_DA)
    ...
    SS.u_DA=pe.Param(SS.I, SS.T,  initialize =  u_DA)
    ...
    print("Total_cost_SS_UC= ", total_cost_SS)
    ...
    plt.savefig('Heat_SS_UC.pdf', dpi=100, bbox_inches='tight')
    plt.show    
    ...
    plt.savefig('Power_SS_UC.pdf', dpi=100, bbox_inches='tight')
    plt.show    
    ...
    plt.savefig('Power_Price_SS_UC.pdf', dpi=100, bbox_inches='tight')
    plt.show()  
    ...
    ax7.set_ylim(-10, 300)
    plt.savefig('CHP_dispatch_SS_big_UC.pdf', dpi=100, bbox_inches='tight')
    plt.show
    
    return Wind_curt_total, total_cost_SS
